    ...
    <div class="orders">
      ...
      <div v-for="order in filteredOrders" :key="order.id" class="order">
        ...
        <div class="order-item status">
          ...
          <button   @click="router.push({ name: 'BriefView', params: { type: order.brief_type, id: order.id }, query: { title: order.title } })" type="submit" class="order-item__open">Посмотреть</button>
        </div>
      </div>
    </div>
