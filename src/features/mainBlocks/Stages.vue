...
const slides = ref([
  ...
  },
  {
    ...
    text: "Презентуем готовый дизайн главной страницы сайта, представляем своё виденение и аргументируем решения. После согласования доделываем остальные страницы"
  },
  {
